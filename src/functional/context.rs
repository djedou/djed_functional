use crate::functional::function::{get_current_scope, use_hook, Hook};
use std::any::TypeId;
...
use djed::{
    ...
    macros::Properties,
    djed::{
    AnyScope, Scope, Children, Component, ComponentLink, Html
    }
};
///
...
impl<T: Clone + PartialEq + 'static> Component for ContextProvider<T> {
    ...
    fn update(&mut self, _msg: Self::State) -> bool {
        true
    }
